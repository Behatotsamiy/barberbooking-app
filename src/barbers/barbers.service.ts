...
export class BarbersService {
  ...
  async createBarber(createBarberDto: CreateBarberDto, imageUrls: string | null): Promise<Barber> {
    ...
    const barber = this.barbersRepository.create({...createBarberDto, picture: imageUrls && Array.isArray(imageUrls) ? imageUrls : null });
